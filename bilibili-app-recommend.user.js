...
// @require      https://registry.npmmirror.com/dayjs/1.11.11/files/dayjs.min.js
// @require      https://registry.npmmirror.com/dayjs/1.11.11/files/plugin/duration.js
// @require      https://registry.npmmirror.com/@ant-design/cssinjs/1.21.0/files/dist/umd/cssinjs.min.js
// @require      https://registry.npmmirror.com/antd/5.18.3/files/dist/antd-with-locales.min.js
...
(async function (dayjs, duration, React__default, UAParser, lodash, axios, antd, gmAdapter, cssinjs, zhCN, require$$0, localforage, framerMotion, debounce, throttle$1) {
   ...
   */
  var f$2 = React__default, k$2 = Symbol.for("react.element"), l$3 = Symbol.for("react.fragment"), m$4 = Object.prototype.hasOwnProperty, n$3 = f$2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p$3 = {
    key: true,
    ref: true,
    __self: true,
    __source: true
  ...
  function ruleset(value, root2, parent, index, offset, rules, points, type, props, children, length2) {
    ...
    for (var i2 = 0, j = 0, k2 = 0; i2 < index; ++i2) for (var x2 = 0, y2 = substr(value, post + 1, post = abs(j = points[i2])), z2 = value; x2 < size2; ++x2) if (z2 = trim(j > 0 ? rule[x2] + " " + y2 : replace(y2, /&\f/g, rule[x2]))) props[k2++] = z2;
  ...
  function serialize(children, callback) {
    ...
    for (var i2 = 0; i2 < length2; i2++) output += callback(children[i2], i2, children, callback) || "";
    return output;
  }
   ...
   * LICENSE file in the root directory of this source tree.
   */
  var b = "function" === typeof Symbol && Symbol.for, c$1 = b ? Symbol.for("react.element") : 60103, d$2 = b ? Symbol.for("react.portal") : 60106, e$2 = b ? Symbol.for("react.fragment") : 60107, f$1 = b ? Symbol.for("react.strict_mode") : 60108, g = b ? Symbol.for("react.profiler") : 60114, h$3 = b ? Symbol.for("react.provider") : 60109, k$1 = b ? Symbol.for("react.context") : 60110, l$2 = b ? Symbol.for("react.async_mode") : 60111, m$3 = b ? Symbol.for("react.concurrent_mode") : 60111, n$2 = b ? Symbol.for("react.forward_ref") : 60112, p$2 = b ? Symbol.for("react.suspense") : 60113, q$1 = b ? Symbol.for("react.suspense_list") : 60120, r$3 = b ? Symbol.for("react.memo") : 60115, t$2 = b ? Symbol.for("react.lazy") : 60116, v = b ? Symbol.for("react.block") : 60121, w$2 = b ? Symbol.for("react.fundamental") : 60117, x = b ? Symbol.for("react.responder") : 60118, y$2 = b ? Symbol.for("react.scope") : 60119;
  function z(a2) {
  ...
  reactIs_production_min.isValidElementType = function(a2) {
    return "string" === typeof a2 || "function" === typeof a2 || a2 === e$2 || a2 === m$3 || a2 === g || a2 === f$1 || a2 === p$2 || a2 === q$1 || "object" === typeof a2 && null !== a2 && (a2.$$typeof === t$2 || a2.$$typeof === r$3 || a2.$$typeof === h$3 || a2.$$typeof === k$1 || a2.$$typeof === n$2 || a2.$$typeof === w$2 || a2.$$typeof === x || a2.$$typeof === y$2 || a2.$$typeof === v);
  };
  ...
  const isEdge = ((_d = uaParseResult.browser.name) == null ? void 0 : _d.toLowerCase()) === "edge";
  function mitt(n2) {
    ...
    return w2 && w2[1].f === !!h2 || (w2 = ((o2, s3) => {
      ...
      const f3 = (e2, t2) => {
        if (!l2) {
          ...
          if (s4 || (s4 = {}, c3[r$2].set(o2, s4)), e2 === n$1) s4[n$1] = true;
          else {
            let r2 = s4[e2];
        ...
        get: (e2, n2) => n2 === t$1 ? o2 : (f3("k", n2), a(Reflect.get(e2, n2), c3[r$2], c3.c, c3.t)),
        has: (t2, n2) => n2 === e$1 ? (l2 = true, c3[r$2].delete(o2), true) : (f3("h", n2), Reflect.has(t2, n2)),
        getOwnPropertyDescriptor: (e2, t2) => (f3("o", t2), Reflect.getOwnPropertyDescriptor(e2, t2)),
        ownKeys: (e2) => (f3(n$1), Reflect.ownKeys(e2))
      };
  ...
  var k = "function" === typeof Object.is ? Object.is : h$1, l = e.useState, m$2 = e.useEffect, n = e.useLayoutEffect, p = e.useDebugValue;
  function q(a2, b2) {
    var d2 = b2(), f2 = l({
      inst: {
        value: d2,
...
`;
  ...
  (function() {
    var base64map = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", crypt$1 = {
      ...
      endian: function(n2) {
        ...
        for (var i2 = 0; i2 < n2.length; i2++) n2[i2] = crypt$1.endian(n2[i2]);
        return n2;
      },
      ...
      bytesToWords: function(bytes) {
        for (var words = [], i2 = 0, b2 = 0; i2 < bytes.length; i2++, b2 += 8) words[b2 >>> 5] |= bytes[i2] << 24 - b2 % 32;
        return words;
      },
      ...
      bytesToBase64: function(bytes) {
        for (var base64 = [], i2 = 0; i2 < bytes.length; i2 += 3) {
          ...
          for (var j = 0; j < 4; j++) if (i2 * 8 + j * 6 <= bytes.length * 8) base64.push(base64map.charAt(triplet >>> 6 * (3 - j) & 63));
          else base64.push("=");
        }
        return base64.join("");
      },
  ...
  var charenc = {
    ...
    bin: {
      // Convert a string to a byte array
      stringToBytes: function(str) {
        for (var bytes = [], i2 = 0; i2 < str.length; i2++) bytes.push(str.charCodeAt(i2) & 255);
        return bytes;
      },
      // Convert a byte array to a string
      bytesToString: function(bytes) {
        for (var str = [], i2 = 0; i2 < bytes.length; i2++) str.push(String.fromCharCode(bytes[i2]));
        return str.join("");
      }
    }
  };
  ...
  async function tryAction(selector, action2, moreOptions) {
    ...
    let arr2 = [];
    const query = () => {
      arr2 = Array.from(document.querySelectorAll(selector));
      if (selectorPredicate) arr2 = arr2.filter(selectorPredicate);
    };
    query();
    const start = performance.now();
    const timeoutAt = start + timeout;
    while (!arr2.length && performance.now() < timeoutAt) {
  ...
  function IconWrapper(name, rtl, render4) {
...
`;
  ...
  function equal(a2, b2) {
    ...
    if (a2 && b2 && typeof a2 == "object" && typeof b2 == "object") {
      ...
      if (hasMap && a2 instanceof Map && b2 instanceof Map) {
        ...
        it = a2.entries();
        while (!(i2 = it.next()).done) if (!equal(i2.value[1], b2.get(i2.value[0]))) return false;
        return true;
      }
      ...
      if (hasArrayBuffer && ArrayBuffer.isView(a2) && ArrayBuffer.isView(b2)) {
        length2 = a2.length;
        if (length2 != b2.length) return false;
        for (i2 = length2; i2-- !== 0; ) if (a2[i2] !== b2[i2]) return false;
        return true;
      }
  ...
  const iconParkOutlineConcern = (props) => /* @__PURE__ */ jsx("svg", {
    ...
    children: /* @__PURE__ */ jsxs("g", {
      ...
      children: [/* @__PURE__ */ jsx("path", {
        ...
        strokeLinejoin: "round",
        strokeWidth: 3.5,
        d: "M28.182 20C30.29 20 32 21.612 32 23.6c0 2.588-2.546 4.8-3.818 6c-.849.8-1.91 1.6-3.182 2.4c-1.273-.8-2.333-1.6-3.182-2.4c-1.273-1.2-3.818-3.412-3.818-6c0-1.988 1.71-3.6 3.818-3.6c1.328 0 2.498.64 3.182 1.61c.684-.97 1.854-1.61 3.182-1.61Z"
      })]
    })
  });
  const iconParkOutlineFileCabinet = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 48 48",
    width: "1.2em",
    height: "1.2em",
    ...props,
  ...
  const TabConfig = {
    ...
    [ETab.Watchlater]: {
      icon: /* @__PURE__ */ jsx(iconParkOutlineFileCabinet, {
        ...size(15)
      }),
      label: "稍后再看",
  ...
  function copyBvidsInfo() {
    const bvids = getGridCardData().map((cardData) => [`# [${cardData.authorName}] ${cardData.pubdateDisplay} ${cardData.title}`, cardData.bvid]).flat();
    GM.setClipboard(bvids.join("\n"));
  }
  ...
  function useRefresh({
    ...
    const refresh = useMemoizedFn(async (reuse = false, options) => {
      ...
      const shouldReuse = reuse && hasCache(tab2);
      const swr = shouldReuse && !!TabConfig[tab2].swr;
      ...
      debug2("refresh(): shouldReuse=%s swr=%s useGridCache=%s", shouldReuse, swr, useGridCache);
      if (shouldReuse) {
        if (swr) {
      ...
      if (_items.length) {
        if (TabConfig[tab2].swr || tab2 === ETab.Fav || tab2 === ETab.Hot) {
          setCacheFor(tab2, _items.slice(0, 30));
        } else {
          setCacheFor(tab2, _items);
        }
      }
      if (_signal.aborted) {
  ...
  function getSortedTabKeys(customTabKeysOrder) {
    return TabKeys.slice().sort((a2, b2) => {
      ...
      if (aIndex === -1) aIndex = TabKeys.indexOf(a2);
...
`;
  ...
  function CloseThenOpenButton({
    ...
    const onClick = () => {
      ...
      u2.searchParams.delete(PLAYER_SCREEN_MODE);
      GM.openInTab(u2.href, {
        active: true
      });
    };
    ...
    const onOpenWithMode = useMemoizedFn((mode) => {
      ...
      const newHref = getHref((u2) => {
        if (mode === VideoLinkOpenMode.Popup || mode === VideoLinkOpenMode.NormalWebFullscreen) {
          u2.searchParams.set(PLAYER_SCREEN_MODE, PlayerScreenMode.WebFullscreen);
        }
      });
      function commonOpen() {
      ...
      const handlers = {
        [VideoLinkOpenMode.Normal]: commonOpen,
        [VideoLinkOpenMode.Background]: commonOpen,
        [VideoLinkOpenMode.NormalWebFullscreen]: commonOpen,
        [VideoLinkOpenMode.Popup]: () => handlePopup(newHref),
        [VideoLinkOpenMode.Iina]: openInIINA
      };
...
`;
  ...
  (function(exports) {
    ...
    exports.RetryError = exports.pretry = exports.TimeoutError = void 0;
    const ptimeout2 = promise_timeoutExports;
    var promise_timeout_1 = promise_timeoutExports;
    Object.defineProperty(exports, "TimeoutError", {
      enumerable: true,
      get: function() {
        return promise_timeout_1.TimeoutError;
      }
    });
    exports.default = pretry2;
    function pretry2(fn, options) {
      const originalFn = fn;
      options = options || {};
      const times = options.times || 5;
      const _timeout = options.timeout;
      if (_timeout) {
        fn = ptimeout2(fn, _timeout);
      }
      ...
      return async function pretryWrapper(...args) {
        ...
        for (let i2 = 0; i2 < times; i2++) {
          ...
          if (options.delay) {
            const delay2 = typeof options.delay === "number" ? options.delay : options.delay(i2);
  ...
  const pretry = /* @__PURE__ */ getDefaultExportFromCjs(lib);
  ...
  function uniqFilter(existing, newItems) {
      ...
      try {
        ...
        if (service) {
          ...
          while (!(newItems.length > itemsBox.val.length)) {
            const times = tab2 === ETab.KeepFollowOnly ? 5 : 2;
    ...
    if (refreshError) {
      ...
      return /* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsx("p", {
          ...
          className: "mt-8px flex items-center justify-center",
  ...
  function SettingsGroup({
    ...
    return /* @__PURE__ */ jsxs("div", {
      css: S$2.settingsGroup,
      "data-as": "settings-group",
      ...rest,
      children: [/* @__PURE__ */ jsx("div", {
        css: [S$2.settingsGroupTitle, titleCss, "", ""],
        "data-as": "settings-group-title",
        children: title
      }), /* @__PURE__ */ jsx("div", {
        css: S$2.settingsGroupContent,
  ...
  const renderOnce = lodash.once(function render3() {
    const container = document.createElement("div");
        ...
        title: /* @__PURE__ */ jsxs(Fragment, {
          children: ["帮助", /* @__PURE__ */ jsxs("span", {
            css: css`
                ...
                top: 4px;
              `,
            children: ["(当前版本: v", "0.24.3", ")"]
          }), /* @__PURE__ */ jsx(IconPark, {
            name: "Copy",
            size: 16,
            onClick: () => {
              const content = `v${"0.24.3"}`;
              GM.setClipboard(content);
...
})(dayjs, dayjs_plugin_duration, React, UAParser, _, axios, antd, axiosGmxhrAdapter, antdCssinjs, antd.locales.zh_CN, ReactDOM, localforage, Motion, _.debounce, _.throttle);
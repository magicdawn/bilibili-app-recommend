...
(async function (dayjs, duration, React__default, UAParser, lodash, axios, antd, cssinjs, zhCN, require$$0, localforage, framerMotion, debounce, throttle$1) {
  ...
  const createSnapshotDefault = (target, version) => {
    ...
    Reflect.ownKeys(target).forEach((key2) => {
      ...
      if (refSet.has(value)) {
        ...
        const [target2] = proxyStateMap$2.get(value);
  ...
  const maybeProxify = (x2) => typeof x2 === "object" ? proxy({ x: x2 }).x : x2;
    ...
    if (initialValues) {
      ...
      for (const value of initialValues) {
        if (!indexMap.has(value)) {
          const v2 = maybeProxify(value);
          indexMap.set(v2, initialIndex);
          initialData[initialIndex++] = v2;
        }
      }
    }
    const vObject = {
      ...
      add(value) {
        ...
        const v2 = maybeProxify(value);
        if (!indexMap.has(v2)) {
          indexMap.set(v2, this.index);
          this.data[this.index++] = v2;
        }
        return this;
      },
      delete(value) {
  ...
  const isProxy = (x2) => proxyStateMap.has(x2);
  function proxyMap(entries) {
    ...
    const vObject = {
      ...
      set(key2, value) {
        ...
        const index = indexMap.get(key2);
        if (index === void 0) {
          indexMap.set(key2, this.index);
      ...
      forEach(cb) {
        const map = getMapForThis(this);
        map.forEach((index, key2) => {
          cb(this.data[index], key2, this);
        });
      },
      *entries() {
        const map = getMapForThis(this);
        for (const [key2, index] of map) {
          yield [key2, this.data[index]];
        }
      },
      *keys() {
        const map = getMapForThis(this);
...
`;
  ...
  const createServiceMap = {
    ...
    [ETab.DynamicFeed]: () => {
      var _a2;
      return new DynamicFeedRecService(dynamicFeedFilterStore.upMid, dynamicFeedFilterStore.searchText, (_a2 = dynamicFeedFilterStore.selectedFollowGroup) == null ? void 0 : _a2.tagid);
    },
  ...
  const tablerFilterSearch = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 24 24",
    width: "1.2em",
    height: "1.2em",
    ...props,
  ...
  class DynamicFeedRecService {
    constructor(upMid, searchText, followGroupTagid) {
      ...
      __publicField(this, "followGroupTagid");
    ...
    async loadMore(signal = void 0) {
      ...
      const items = arr2.filter((x2) => x2.type === "DYNAMIC_TYPE_AV").filter((x2) => {
        ...
        if (!store$1.hasSelectedUp) return true;
        if (store$1.dynamicFeedVideoType === "all") return true;
        const currentLabel = x2.modules.module_dynamic.major.archive.badge.text;
        if (store$1.dynamicFeedVideoType === "dynamic-only") {
          return currentLabel === "动态视频";
        }
        if (store$1.dynamicFeedVideoType === "upload-only") {
      ...
      if (store$1.hasSelectedUp && this.upMid && !store$1.hasChargeOnlyVideoUpSet.has(this.upMid) && items.some((x2) => isChargeOnlyVideo(x2))) {
  ...
  async function updateFollowGroups(force = false) {
    ...
    const cacheHit = !force && store$1.followGroups.length && store$1.followGroupsUpdatedAt && store$1.followGroupsUpdatedAt - Date.now() < ms$1("1h");
    if (cacheHit) return;
    const groups = await getAllFollowGroups();
    store$1.followGroups = groups.filter((x2) => !!x2.count);
    store$1.followGroupsUpdatedAt = Date.now();
  }
  ...
  function DynamicFeedUsageInfo() {
    ...
    React__default.useMemo(() => !!upMid && !!hasChargeOnlyVideoUpSet.has(upMid), [hasChargeOnlyVideoUpSet, upMid]);
    useMount(() => {
      updateFilterData();
    });
    ...
    return /* @__PURE__ */ jsx(Fragment, {
      children: /* @__PURE__ */ jsxs(antd.Space, {
        ...
        children: [/* @__PURE__ */ jsx(antd.Dropdown, {
        ...
        }), hasSelectedUp && /* @__PURE__ */ jsx(antd.Popover, {
          arrow: false,
          placement: "bottomLeft",
          getPopupContainer,
          content: /* @__PURE__ */ jsxs(Fragment, {
            children: [/* @__PURE__ */ jsxs("div", {
              ...
              children: [/* @__PURE__ */ jsx("div", {
                ...
                children: /* @__PURE__ */ jsx(antd.Radio.Group, {
                  ...
                  onChange: async (v2) => {
                    store$1.dynamicFeedVideoType = v2.target.value;
                    await delay(100);
                    onRefresh == null ? void 0 : onRefresh();
                  },
            ...
            }), hasSelectedUp && /* @__PURE__ */ jsxs("div", {
              className: "section",
              css: S$6.filterSection,
              children: [/* @__PURE__ */ jsx("div", {
                className: "title",
          ...
          children: /* @__PURE__ */ jsx(antd.Button, {
            ...
            children: /* @__PURE__ */ jsx(tablerFilterSearch, {})
          })
        })]
      })
    });
...
`;
  ...
  async function refreshForGrid(fetcherOptions) {
    ...
    if (fetcherOptions.tab === ETab.DynamicFeed) {
      ...
      if (service.searchText || service.followGroupTagid || dynamicFeedFilterStore.hasSelectedUp && dynamicFeedFilterStore.dynamicFeedVideoType === DynamicFeedVideoType.DynamicOnly) {
        minCount = 1;
      }
    }

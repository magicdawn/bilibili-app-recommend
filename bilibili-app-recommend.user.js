...
// @require      https://registry.npmmirror.com/framer-motion/11.3.21/files/dist/framer-motion.js
...
// @require      https://registry.npmmirror.com/dayjs/1.11.12/files/dayjs.min.js
// @require      https://registry.npmmirror.com/dayjs/1.11.12/files/plugin/duration.js
// @require      https://registry.npmmirror.com/@ant-design/cssinjs/1.21.0/files/dist/umd/cssinjs.min.js
// @require      https://registry.npmmirror.com/antd/5.20.0/files/dist/antd-with-locales.min.js
...
(async function (dayjs, duration, React__default, UAParser, lodash, axios, antd, cssinjs, zhCN, require$$0, localforage, framerMotion, debounce, throttle$1) {
  ...
  function ruleset(value, root2, parent, index, offset, rules, points, type, props, children, length2) {
    ...
    for (var i2 = 0, j = 0, k2 = 0; i2 < index; ++i2) for (var x2 = 0, y2 = substr(value, post + 1, post = abs(j = points[i2])), z2 = value; x2 < size2; ++x2) if (z2 = trim$1(j > 0 ? rule[x2] + " " + y2 : replace(y2, /&\f/g, rule[x2]))) props[k2++] = z2;
  ...
  var define_import_meta_env_default$1 = { BASE_URL: "/", DEV: false, MODE: "production", PROD: true, SSR: false };
  ...
  var define_import_meta_env_default = { BASE_URL: "/", DEV: false, MODE: "production", PROD: true, SSR: false };
...
`;
  ...
  var parseHeaders = function parseHeaders2(headers) {
    ...
    utils.forEach(headers.split("\n"), function parser(line2) {
      i2 = line2.indexOf(":");
      key2 = utils.trim(line2.substr(0, i2)).toLowerCase();
      val = utils.trim(line2.substr(i2 + 1));
      if (key2) {
    ...
    const onOpenWithMode = useMemoizedFn((mode) => {
      ...
      const newHref = getHref((u2) => {
        ...
        if (settings.startPlayFromPreviewPoint) {
          ...
          if (t2) {
            u2.searchParams.set("t", t2.toString());
          }
        }
      });
      const handleCommon = () => {
        ...
        title: /* @__PURE__ */ jsxs(Fragment, {
          children: ["帮助", /* @__PURE__ */ jsxs("span", {
            css: css`
                ...
                top: 4px;
              `,
            children: ["(当前版本: v", "0.24.8", ")"]
          }), /* @__PURE__ */ jsx(IconPark, {
            name: "Copy",
            size: 16,
            onClick: () => {
              const content = `v${"0.24.8"}`;
              GM.setClipboard(content);

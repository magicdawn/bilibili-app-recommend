...
// @require      https://registry.npmmirror.com/framer-motion/11.11.9/files/dist/framer-motion.js
...
(async function (dayjs, duration, React__default, UAParser, lodash, axios, antd, cssinjs, zhCN, require$$0, localforage, framerMotion, debounce, throttle$1) {
  ...
  function fmtLong(ms2) {
    ...
    if (msAbs >= m$3) {
      return plural(ms2, msAbs, m$3, "minute");
    }
    if (msAbs >= s) {
  ...
  reactIs_production_min.isValidElementType = function(a) {
    return "string" === typeof a || "function" === typeof a || a === e || a === m$1 || a === g || a === f || a === p || a === q || "object" === typeof a && null !== a && (a.$$typeof === t || a.$$typeof === r$1 || a.$$typeof === h || a.$$typeof === k || a.$$typeof === n || a.$$typeof === w || a.$$typeof === x || a.$$typeof === y || a.$$typeof === v);
  };
  ...
  var Emotion = /* @__PURE__ */ withEmotionCache(
    ...
    function(props, cache2, ref) {
      ...
      var newProps = {};
      for (var key2 in props) {
        if (hasOwn.call(props, key2) && key2 !== "css" && key2 !== typePropName && !isDevelopment) {
          newProps[key2] = props[key2];
        }
      }
  ...
  const debug$9 = baseDebug.extend("settings");
  ...
  async function saveToDraft(val) {
    ...
    try {
      ...
      debug$9("backup to article draft complete");
    } catch (e2) {
  ...
  const initialSettings = {
     ...
     * tab=dynamic-feed
     */
    enableFollowGroupFilterForDynamicFeed: true,
    // 下拉筛选支持 - 关注分组
    /**
     * tab=watchlater
     */
  ...
  var _ref3 = {
    name: "1cj7xnv",
    styles: "#i_cecream .bili-feed4-layout{display:none;}.desktop-download-tip,.vip-login-tip{display:none!important;}"
  };
...
`;
  ...
  const debug$8 = baseDebug.extend("utility:dom");
  ...
  async function tryAction(selector, action2, moreOptions) {
    ...
    if (!(arr2 == null ? void 0 : arr2.length)) {
      debug$8("tryAction: timeout for selector = `%s`", selector);
      if (warnOnTimeout) {
        console.warn(`[${APP_NAME}]: tryAction timeout, selector = \`%s\``, selector);
      }
      return;
    }
    debug$8("tryAction: selector=`%s` count=%s", selector, arr2.length);
  ...
  function ModalDislike({
    ...
    const onDislike = useLockFn(async (reason) => {
      ...
      if (success) {
        ...
        AntdMessage.error(message2 || OPERATION_FAIL_MSG);
      }
    });
        ...
        children: [/* @__PURE__ */ jsx("div", {
          ...
          children: reasons.map((reason, index) => {
            ...
            return /* @__PURE__ */ jsxs("button", {
              ...
              css: [S$8.reason, active && S$8.reasonActive, "", ""],
              "data-id": reason.id,
              onClick: () => {
                setActiveIndex(index);
                onDislike(reason);
  ...
  async function getFollowGroupContent(tagid) {
    ...
    const mids = lodash.uniq(items.map((x2) => x2.mid));
    return mids;
  }
  ...
  function getDfStoreFilterConfig() {
    var _a2;
  ...
  async function updateUpList(force = false) {
    const cacheHit = !force && dfStore.upList.length && dfStore.upListUpdatedAt && dfStore.upListUpdatedAt - Date.now() < ms$1("5min");
    if (cacheHit) return;
  ...
  async function updateFollowGroups(force = false) {
    ...
    const cacheHit = !force && dfStore.followGroups.length && dfStore.followGroupsUpdatedAt && dfStore.followGroupsUpdatedAt - Date.now() < ms$1("1h");
    if (cacheHit) return;
    const groups = await getAllFollowGroups();
    dfStore.followGroups = groups.filter((x2) => !!x2.count);
  ...
  const isEqual2 = (x2, y2) => {
    if (Object.is(x2, y2))
      return true;
    if (x2 instanceof Date && y2 instanceof Date) {
      return x2.getTime() === y2.getTime();
    }
    if (x2 instanceof RegExp && y2 instanceof RegExp) {
      return x2.toString() === y2.toString();
    }
    if (typeof x2 !== "object" || x2 === null || typeof y2 !== "object" || y2 === null) {
      return false;
    }
    const keysX = Reflect.ownKeys(x2);
    const keysY = Reflect.ownKeys(y2);
    if (keysX.length !== keysY.length)
      return false;
    for (let i = 0; i < keysX.length; i++) {
      if (!Reflect.has(y2, keysX[i]))
        return false;
      if (!isEqual2(x2[keysX[i]], y2[keysX[i]]))
        return false;
    }
    return true;
  };
  ...
  const VideoCardActionStyle = S$7;
  ...
  function useTooltip({
    ...
    const tooltipEl = /* @__PURE__ */ jsx("span", {
      ...
      css: S$7.tooltip(inlinePosition, tooltipOffset),
      children: tooltip
    });
    return {
      triggerRef,
          ...
          items: [{
            ...
            children: others.map((x2) => {
              return {
                ...
                label: x2.title,
                onClick() {
                  openNewTab(new URL(`/video/${x2.bvid}`, location.href).href);
                }
              };
            })
          }]
  ...
  const tablerFilter = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 24 24",
    width: "1.2em",
    height: "1.2em",
    ...props,
  ...
  const tablerFilterCheck = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 24 24",
    width: "1.2em",
    height: "1.2em",
    ...props,
    children: /* @__PURE__ */ jsx("path", {
      ...
      strokeLinejoin: "round",
      strokeWidth: 2,
      d: "M11.18 20.274L9 21v-8.5L4.52 7.572A2 2 0 0 1 4 6.227V4h16v2.172a2 2 0 0 1-.586 1.414L15 12v3m0 4l2 2l4-4"
    })
  });
  function dynamicFeedFilterSelectUp(payload) {
    Object.assign(dfStore, payload);
    if (payload.upMid) {
      const item = dfStore.upList.find((x2) => x2.mid === payload.upMid);
  ...
  function DynamicFeedUsageInfo() {
    ...
    const {
      enableFollowGroupFilterForDynamicFeed
    } = useSettingsSnapshot();
    const {
      hasSelectedUp,
      upName,
    ...
    const showFilterBadge = React__default.useMemo(() => {
      return showFilter && !!(dynamicFeedVideoType !== DynamicFeedVideoType.All || hideChargeOnlyVideos || searchText);
        ...
        groupItems = followGroups.map((group) => {
          return {
            ...
            onClick() {
              onSelect({
                ...clearPayload,
                selectedFollowGroup: structuredClone({
                  ...group
                })
              });
            }
    ...
    }, [upList, upList.map((x2) => !!x2.has_update), enableFollowGroupFilterForDynamicFeed]);
    /* @__PURE__ */ jsx("div", {
      css: css`
        flex-basis: 100%;
        height: 0;
    ...
    const filterPopoverContent = /* @__PURE__ */ jsxs("div", {
      css: S$6.filterWrapper,
      children: [/* @__PURE__ */ jsxs("div", {
        className: "section",
        css: S$6.filterSection,
        children: [/* @__PURE__ */ jsxs("div", {
          className: "title",
          children: ["视频类型", /* @__PURE__ */ jsxs(HelpInfo, {
            children: ["「", CHARGE_ONLY_TEXT, "」在此程序中归类为「投稿视频」", /* @__PURE__ */ jsx("br", {})]
          })]
        }), /* @__PURE__ */ jsx("div", {
          className: "content",
          children: /* @__PURE__ */ jsx(antd.Radio.Group, {
            ...
            onChange: async (v2) => {
              dfStore.dynamicFeedVideoType = v2.target.value;
              await delay(100);
              onRefresh == null ? void 0 : onRefresh();
            },
            children: Object.values(DynamicFeedVideoType).map((v2) => {
              return /* @__PURE__ */ jsx(antd.Radio.Button, {
                value: v2,
                children: DynamicFeedVideoTypeLabel[v2]
              }, v2);
            })
          })
        })]
          ...
          children: /* @__PURE__ */ jsx(antd.Checkbox, {
            ...
            children: /* @__PURE__ */ jsx(AntdTooltip, {
              title: /* @__PURE__ */ jsxs(Fragment, {
                children: ["隐藏「", CHARGE_ONLY_TEXT, "」视频", /* @__PURE__ */ jsx("br", {}), "程序会针对 UP 或 分组记忆你的选择~"]
              }),
        ...
        children: [/* @__PURE__ */ jsx("div", {
          ...
          className: "content",
          children: /* @__PURE__ */ jsx(antd.Input.Search, {
            style: {
              width: 280
            },
      ...
      children: /* @__PURE__ */ jsxs(antd.Space, {
        ...
        children: [/* @__PURE__ */ jsx(antd.Dropdown, {
          ...
          children: /* @__PURE__ */ jsx(antd.Button, {
            ...
            children: upName ? `UP: ${upName}` : selectedFollowGroup ? `分组 - ${selectedFollowGroup.name}` : "全部"
          })
        }), (hasSelectedUp || selectedFollowGroup) && /* @__PURE__ */ jsxs(antd.Button, {
          onClick: onClear,
          css: [antdCustomCss.button, "", ""],
          className: "gap-0",
          children: [/* @__PURE__ */ jsx(IconPark, {
        ...
        }), showFilter && /* @__PURE__ */ jsx(antd.Popover, {
          arrow: false,
          placement: "bottomLeft",
          getPopupContainer,
          ...
          children: /* @__PURE__ */ jsx(antd.Badge, {
            ...
            children: /* @__PURE__ */ jsx(antd.Button, {
              ...
              children: showFilterBadge ? /* @__PURE__ */ jsx(tablerFilterCheck, {}) : /* @__PURE__ */ jsx(tablerFilter, {})
            })
          })
        })]
      })
  ...
  class DynamicFeedRecService {
    constructor(filterConfig) {
      ...
      // pages loaded
      __publicField(this, "hasMore", true);
      __publicField(this, "followGroupMids", /* @__PURE__ */ new Set());
    ...
    async loadMore(signal = void 0) {
      ...
      const items = arr2.filter((x2) => x2.type === "DYNAMIC_TYPE_AV").filter((x2) => {
        var _a2, _b2;
        if (typeof this.followGroupTagid !== "number") return true;
        if (!this.followGroupMids.size) return true;
        const mid = (_b2 = (_a2 = x2 == null ? void 0 : x2.modules) == null ? void 0 : _a2.module_author) == null ? void 0 : _b2.mid;
        ...
        const currentLabel = x2.modules.module_dynamic.major.archive.badge.text;
        ...
        const chargeOnly = ((_e2 = (_d2 = (_c2 = (_b2 = (_a2 = x2.modules) == null ? void 0 : _a2.module_dynamic) == null ? void 0 : _b2.major) == null ? void 0 : _c2.archive) == null ? void 0 : _d2.badge) == null ? void 0 : _e2.text) === CHARGE_ONLY_TEXT;
        return !chargeOnly;
      }).filter((x2) => {
        var _a2, _b2, _c2, _d2;
        if (!this.showFilter) return true;
        if (!this.searchText) return true;
        const title = ((_d2 = (_c2 = (_b2 = (_a2 = x2 == null ? void 0 : x2.modules) == null ? void 0 : _a2.module_dynamic) == null ? void 0 : _b2.major) == null ? void 0 : _c2.archive) == null ? void 0 : _d2.title) || "";
    ...
    async loadMore() {
      ...
      if (this.qs.bufferQueue.length < _FavRecService.PAGE_SIZE) {
        while (this.folderHasMore && this.qs.bufferQueue.length < _FavRecService.PAGE_SIZE) {
          ...
          this.qs.bufferQueue = lodash.shuffle([...this.qs.bufferQueue, ...lodash.shuffle(fetched)]);
        }
      }
      return this.qs.sliceFromQueue();
    }
  ...
  const _WatchLaterRecService = class _WatchLaterRecService {
    ...
    async fetch() {
      ...
      const json = res.data;
      const items = (((_a2 = json == null ? void 0 : json.data) == null ? void 0 : _a2.list) || []).map((item) => {
        return {
          ...item,
      ...
      this.count = (((_b2 = json == null ? void 0 : json.data) == null ? void 0 : _b2.list) || []).length;
  ...
  function useRefresh({
    ...
    const refresh = useMemoizedFn(async (reuse = false, options) => {
      ...
      if (refreshing) {
        if (tab2 === refreshFor) {
          let s2;
          if (tab2 === ETab.DynamicFeed && (s2 = serviceMap[ETab.DynamicFeed]) && !isEqual2(s2.filterConfig, getDfStoreFilterConfig())) {
  ...
  function HotUsageInfo({
    ...
    return /* @__PURE__ */ jsxs(Fragment, {
      children: [dropdownMenu, children]
    });
  }
...
`;
  ...
  function filterRecItems(items, tab2) {
    ...
    const settings2 = getSettingsSnapshot();
  ...
  function getBiliPlayerConfig() {
    const key2 = "bpx_player_profile";
    const str = localStorage.getItem(key2);
    if (!str) return;
    try {
...
`;
  ...
  async function refreshForGrid(fetcherOptions) {
    ...
    if (fetcherOptions.tab === ETab.DynamicFeed) {
      const s2 = fetcherOptions.serviceMap[ETab.DynamicFeed];
      if (s2.followGroupTagid || // 选择了分组 & 分组很少更新
      s2.showFilter && (s2.searchText || s2.dynamicFeedVideoType === DynamicFeedVideoType.DynamicOnly)) {
        minCount = 1;
      }
    }
  ...
  async function importSettings() {
    ...
    const pickedSettings = lodash.pick(settingsFromFile || {}, allowedSettingsKeys);
  ...
  const tablerFileExport = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 24 24",
    width: "1.2em",
    height: "1.2em",
    ...props,
  ...
  const tablerFileImport = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 24 24",
    width: "1.2em",
    height: "1.2em",
    ...props,
  ...
  const tablerRestore = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 24 24",
    width: "1.2em",
    height: "1.2em",
    ...props,
      ...
      children: [/* @__PURE__ */ jsx(SettingsGroup, {
        ...
        children: /* @__PURE__ */ jsxs(antd.Space, {
          ...
          children: [/* @__PURE__ */ jsx(antd.Popconfirm, {
            ...
            children: /* @__PURE__ */ jsxs(antd.Button, {
              danger: true,
              type: "primary",
              children: [/* @__PURE__ */ jsx(tablerRestore, {}), "恢复默认设置"]
            })
            ...
            children: [/* @__PURE__ */ jsx(AntdTooltip, {
              ...
              children: /* @__PURE__ */ jsxs(antd.Button, {
                ...
                children: [/* @__PURE__ */ jsx(tablerFileExport, {}), "导出设置"]
              })
            }), /* @__PURE__ */ jsx(AntdTooltip, {
              title: "从文件中导入设置项, 将覆盖当前设置, 该操作不可逆!",
              children: /* @__PURE__ */ jsxs(antd.Button, {
                onClick: () => importSettings(),
                children: [/* @__PURE__ */ jsx(tablerFileImport, {}), "导入设置"]
              })
            })]
          })]
        })
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: /* @__PURE__ */ jsxs(antd.Button, {
            danger: true,
            type: "primary",
            children: [/* @__PURE__ */ jsx(tablerRestore, {}), "从专栏草稿箱中恢复"]
          })
        })]
      }), /* @__PURE__ */ jsxs(SettingsGroup, {
        titleCss: css`
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              ...
              children: [/* @__PURE__ */ jsxs("div", {
                ...
                children: /* @__PURE__ */ jsx(CheckboxSettingItem, {
                  ...
                  label: "启用分组筛选",
                  tooltip: /* @__PURE__ */ jsxs(Fragment, {
                    children: ["动态筛选里加入分组", /* @__PURE__ */ jsx("br", {}), "目前基于全部动态 + 分组UP过滤, 速度较慢~", /* @__PURE__ */ jsx("br", {}), "且貌似只能拉取最近一个月的动态数据"]
                  })
                })
              })]
            }), /* @__PURE__ */ jsxs("div", {
  ...
  const getWin = () => typeof unsafeWindow !== "undefined" ? unsafeWindow : globalThis;
  const getId = () => ({
    aid: getWin().aid,
    cid: getWin().cid
  });

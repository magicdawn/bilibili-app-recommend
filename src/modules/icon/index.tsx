...
export const DislikeIcon = IconPhThumbsDownDuotone
export const ConfigIcon = IconIconParkOutlineConfig
export const PlayerIcon = IconIconParkOutlinePlayTwo
export const OpenExternalLinkIcon = IconMaterialSymbolsLightOpenInNew
...
export function WatchLaterIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg

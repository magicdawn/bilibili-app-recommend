...
export const IconForConfig = IconIconParkOutlineConfig
export const IconForPlayer = IconIconParkOutlinePlayTwo
...
export const IconForInfo = IconIconParkOutlineInfo

// orders
export const IconForDefaultOrder = IconMdiShuffleDisabled
export const IconForShuffle = IconCuidaShuffleOutline
export const IconForTimestamp = IconIconParkOutlineTime

// Tabs
export const IconForPhone = IconIconParkOutlineIphone
export const IconForPc = IconIconParkOutlineComputer
export const IconForFollowedOnly = IconIconParkOutlineConcern
export const IconForDynamicFeed = IconIconParkOutlineTumblr
export const IconForFav = IconIconParkOutlineStar
export const IconForFaved = IconIconParkSolidStar // faved variant
export const IconForHot = IconIconParkOutlineFire

// actions
export const IconForBlacklist = IconIconParkOutlinePeopleDelete
export const IconForReset = IconIconParkOutlineReturn
export const IconForCopy = IconIconParkOutlineCopy
